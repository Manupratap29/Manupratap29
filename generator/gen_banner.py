...
rows = [
    ("Subject", "Manu Pratap Singh Tanwar"),
    ("Role", "AI Engineer"),
    ("Origin", "Jaipur, India"),
    ("Education", "BCA · Poornima University"),
    ("Status", "Building + Learning + Shipping"),
    ("Streak", "12+ months · 256 contributions/yr"),
    ("ToolChain", "Git, GitHub, Framer, n8n"),
    ("Core.Lang", "Python, C, SQL, JavaScript"),
    ("Core.Data", "NumPy, pandas, matplotlib, SQLite"),
    ("Core.AI/Auto", "AI Agents, n8n, Workflow Automation"),
    ("Core.Web", "Framer, HTML5, CSS3"),
    ("Grid.Mail", "mpstanwar29@gmail.com"),
    ("Grid.Portfolio", "manu-portfolio.framer.website"),
    ("Grid.LinkedIn", "in/manu-pratap-singh-tanwar"),
